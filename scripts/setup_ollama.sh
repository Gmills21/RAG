...
echo ""
echo "Next steps:"
echo "  1. Run: ./scripts/smoke_test_ollama.sh   (optional: verify chat + embeddings)"
echo "  2. Run: ./scripts/preflight.sh           (verify Docker, Ollama, ports, sample data)"
echo "  3. Run: docker compose up -d             (start Kotaemon)"
